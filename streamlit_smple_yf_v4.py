...
def main():
    """Main Streamlit app"""
    st.title("Financial Statement Analyzer with Azure OpenAI")
    ...
    ticker = st.text_input("Enter Stock Ticker Symbol", value="TSLA").upper()
    ...
    if ticker and pdf_file:
        try:
            ...
            # Risk HTML
            risk_items = ""
            for key, title in [("input_cost_risks", "Input Cost Risks"), ("operational_risks", "Operational Risks"),
                               ("financial_risks", "Financial & Debt Risks"), ("regulatory_risks", "Regulatory & Compliance Risks"),
                               ("strategic_risks", "Strategic Implications")]:
        ...
        st.info("Please enter a ticker symbol and upload a 10-Q PDF to proceed.")
